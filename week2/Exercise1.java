...
public class Exercise1 {
    ...
    public static void triangleDetails (double side1,double side2, double side3){
        ...
        if(side1 == side2 && side1 == side3)
            category = "equilarteral";
        else if(side1 == side2 && side1 != side3 || side1 == side3 && side1 !=side2 || side2 == side3 && side2 !=side1 )
            category = "isosceles";
        else
            category = "scalene";

        JOptionPane.showMessageDialog(null,"The area of the triangle is : "+ String.format("%.2f", area + "and it is a " + category + "triangle"),"area of triangle" ,JOptionPane.INFORMATION_MESSAGE);
